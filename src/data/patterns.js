    ...
    "nodes": {
      ...
      "hero_inner": {
        ...
        "props": {
          ...
          "className": "flex flex-col gap-10 w-full max-w-(--content-width) mx-auto items-center md:flex-row md:gap-16 md:items-center"
        },
        "displayName": "Container",
        "parent": "sec_hero",
        "nodes": [
    ...
    "nodes": {
      ...
      "feat_inner": {
        ...
        "props": {
          ...
          "className": "flex flex-col gap-12 w-full max-w-(--content-width) mx-auto"
        },
        "displayName": "Container",
        "parent": "sec_features",
        "nodes": [
      ...
      "feat_grid": {
        ...
        "props": {
          ...
          "className": "grid grid-cols-1 gap-6 w-full md:grid-cols-3"
        },
        "displayName": "Container",
        "parent": "feat_inner",
        "nodes": [
      ...
      "feat_card1": {
        ...
        "props": {
          ...
          "className": "bg-(--background) rounded-(--radius) shadow-(--shadow-style) flex flex-col gap-3 p-6"
        },
        "displayName": "Container",
        "parent": "feat_grid",
        "nodes": [
    ...
    "nodes": {
      "sec_cta": {
        ...
        "props": {
          ...
          "className": "bg-(--primary) flex flex-col items-center w-full py-16 px-(--container-padding-x) md:py-20"
        },
        "displayName": "Container",
        "parent": "page_home",
        "nodes": [
